...
const variantStyles: { [variant: string]: string } = {
  primary:
    'bg-stratos-300 font-semibold text-zinc-100 hover:bg-opacity-60 active:bg-stratos-300/70 active:text-zinc-100/70 dark:active:bg-stratos-300/40 dark:active:text-zinc-100/70',
  secondary:
