...
const variantStyles: { [variant: string]: string } = {
  primary:
    'bg-stratos-400 font-semibold text-zinc-100 hover:bg-opacity-80 active:bg-stratos-400/70 active:text-zinc-100/70 dark:active:bg-stratos-400/40 dark:active:text-zinc-100/70',
  secondary:
